...
exports.AbstractObfuscatedExpressionTree = void 0;
const AbstractExpressionTree_1 = require("../AbstractExpressionTree/AbstractExpressionTree");
const KeyStore_1 = require("../keystore/KeyStore");
const ObfuscatedError_1 = require("./ObfuscatedError");
const AbstractTree_1 = require("../AbstractTree/AbstractTree");
class AbstractObfuscatedExpressionTree extends AbstractExpressionTree_1.AbstractExpressionTree {
    constructor(tree, rootNodeId, nodeContent) {
        ...
        this._internalTree =
            tree ||
                AbstractExpressionTree_1.AbstractExpressionTree.fromPojo({
                    // @ts-ignore -null not assignable to object (nodeContent)
                    root: { parentId: "root", nodeContent: AbstractTree_1.AbstractTree.EmptyNode },
                }); // I think this is because it's not using GenericNode (null, tree, content)
        this._keyStore = new KeyStore_1.KeyStore();
        this._internalTree
    ...
    createSubtreeAt(targetParentNodeId) {
        ...
        subtree._keyStore = new KeyStore_1.KeyStore(); // this is bad idea if we want to initialize with nodeContent
    ...
    rootNodeId, nodeContent) {
        ...
        const internalTree = new AbstractExpressionTree_1.GenericExpressionTree(rootNodeId, nodeContent);
    ...
    _getNodeIdOrThrow(nodeKey) {
        ...
        if (nodeId === undefined) {
            throw new ObfuscatedError_1.ObfuscatedError(`Failed to find nodeId with key: '${nodeKey}'.`);
        }
        return nodeId;
    }
    isLeaf(nodeKey) {
    ...
    static fromPojo(srcPojoTree) {
        ...
        const tree = AbstractExpressionTree_1.AbstractExpressionTree.fromPojo(srcPojoTree);
        // @ts-ignore - typing
        AbstractExpressionTree_1.AbstractExpressionTree.validateTree(tree);
        //@ts-ignore - typing
...
exports.AbstractObfuscatedExpressionTree = AbstractObfuscatedExpressionTree;
