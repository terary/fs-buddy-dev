...
exports.GenericExpressionTree = exports.AbstractExpressionTree = void 0;
const AbstractTree_1 = require("../AbstractTree/AbstractTree");
const DirectedGraphError_1 = require("../DirectedGraphError");
const treeUtilities_1 = __importDefault(require("../AbstractDirectedGraph/treeUtilities"));
const ExpressionTreeError_1 = require("./ExpressionTreeError");
...
// };
class AbstractExpressionTree extends AbstractTree_1.AbstractTree {
        ...
        allNodeIds.forEach((nodeId) => {
            if (tree.isBranch(nodeId)) {
                ...
                if (childrenIds.length < 2) {
                    throw new ExpressionTreeError_1.ExpressionTreeError(`Tree fails no-single-child rule. childIds: '${childrenIds.join("', '")}'.`);
                }
            }
        });
    }
}
exports.AbstractExpressionTree = AbstractExpressionTree;
...
exports.GenericExpressionTree = GenericExpressionTree;
