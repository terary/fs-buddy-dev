...
exports.AddressTree = void 0;
const JsPredicateTree_1 = require("./JsPredicateTree");
const treeUtilities_1 = __importDefault(require("../treeUtilities"));
const helperFunctions_1 = require("./helperFunctions");
const defaultFromPojoTransform = (nodeContent) => {
    return nodeContent.nodeContent;
};
class AddressTree extends JsPredicateTree_1.JsPredicateTree {
    toFunctionBody(rootNodeId = this.rootNodeId, subjects) {
        ...
        Object.entries(subSubject).forEach(([subjectId, subject]) => {
            ...
            const term = ` record['${nodeContent.subjectId}'] ${helperFunctions_1.predicateOperatorToJsOperator(nodeContent.operator)} ${helperFunctions_1.quoteValue(
    ...
    static fromPojo(srcPojoTree, transform = defaultFromPojoTransform, instanceBuilder = (nodeId, nodeContent) => {
        ...
        const pojoRootNodeId = treeUtilities_1.default.parseUniquePojoRootKeyOrThrow(srcPojoTree);
