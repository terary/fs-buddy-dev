...
exports.JsPredicateTree = void 0;
const src_1 = require("../../../src");
const UtilizedLeafVisitor_1 = require("./UtilizedLeafVisitor");
const helperFunctions_1 = require("./helperFunctions");
const commentOutObject = (obj) => {
    const json = JSON.stringify(obj, null, 2);
    return "//" + json.replace(/\n/gi, "\n//");
};
class JsPredicateTree extends src_1.AbstractExpressionTree {
    ...
    toFunctionBody(rootNodeId = this.rootNodeId, subjects) {
        if (this.isSubtree(rootNodeId)) {
            ...
            return ` (record['${subjectId}'] ${operator} ${helperFunctions_1.quoteValue(datatype, value)}) `;
        }
            ...
            return ("(" +
                this.getChildrenNodeIdsOf(rootNodeId, true)
                    ...
                    .join(` ${helperFunctions_1.predicateJunctionToJsOperator(operator)} `) +
                ")");
        }
        else {
    ...
    commentedRecord(subjects) {
        const leafVisitor = new UtilizedLeafVisitor_1.UtilizedLeafVisitor();
...
exports.JsPredicateTree = JsPredicateTree;
