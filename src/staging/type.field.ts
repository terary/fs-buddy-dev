...
import { TFsFieldLogicJunction, TFsJunctionOperators } from "./types.subtree";
...
type TFsFieldAddress = TFsBaseFieldType & {
  ...
  show_country: boolean; // example: 0 | 1
  format: "US"; // probably some others
  hide_address: boolean; // example: 0 | 1
  hide_address2: boolean; // example: 0 | 1
  hide_city: boolean; // example: 0 | 1
  hide_state: boolean; // example: 0 | 1
  hide_zip: boolean; // example: 0 | 1
};
